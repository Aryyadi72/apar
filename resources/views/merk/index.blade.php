...
@section('content')
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-icon btn-primary" id="modal-1"
                                                            data-toggle="modal"
                                                            data-target="#editModal-{{ $merk->id }}"><i
                                                                class="far fa-edit"></i></button>
                                                        <button class="btn btn-icon btn-danger" id="modal-1"
                                                            data-toggle="modal"
                                                            data-target="#deleteModal-{{ $merk->id }}"><i
                ...
                <form action="{{ route('merk.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Masukkan nama merk" name="merk">
                        </div>
                    </div>
    ...
    @foreach ($merks as $merk)
        <div class="modal fade" tabindex="-1" role="dialog" id="editModal-{{ $merk->id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="deleteModal-{{ $merk->id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="{{ route('merk.delete', $merk->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <div class="modal-body">
